...
void Game::init(BOEngine* engine, Shader* shader)
{
	...
	box->addComponent(new RigidBodyComponent(addCube(1.0, 1.0, 1.0, 5.0, 10.0, 0, 1.0, 0, 0, 0)));
	...
	box2->addComponent(new RigidBodyComponent(addCube(1.0, 1.0, 1.0, 5.0, 15.0, 0, 1.0, 0, 0, 0)));
	...
	box3->addComponent(new RigidBodyComponent(addCube(1.0, 1.0, 1.0, 5.0, 20.0, 0, 1.0, 0, 0, 0)));
	...
	box4->addComponent(new RigidBodyComponent(addCube(1.0, 1.0, 1.0, 5.0, 25.0, 0, 1.0, 0, 0, 0)));
