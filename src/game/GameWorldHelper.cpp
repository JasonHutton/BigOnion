...
void GameWorldHelper::initTestScene(BOEngine* engine)
{
	...
	player_car->addComponent(RigidBodyComponent::createWithCube(1.0, 0.3, 1.0, 1.0, 1.0, 0));
	...
	trackWall->addComponent(RigidBodyComponent::createWithMesh(&trackWall->getComponent<RenderComponent>()->model, 1.0, 1)); // connect object - rigibody
	...
	box->addComponent(RigidBodyComponent::createWithCube(1.0, 1.0, 1.0, 1.0, 0.0, -1));
	...
	box2->addComponent(RigidBodyComponent::createWithCube(1.0, 1.0, 1.0, 1.0, 0.0, -1));
	...
	box3->addComponent(RigidBodyComponent::createWithCube(1.0, 1.0, 1.0, 1.0, 0.0, -1));
	...
	box4->addComponent(RigidBodyComponent::createWithCube(1.0, 1.0, 1.0, 1.0, 0.0, -1));
