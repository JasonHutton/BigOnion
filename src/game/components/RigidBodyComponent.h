...
public:
	...
	static RigidBodyComponent* createWithCube(float width, float height, float depth, float mass, float bounciness, int id);
	...
	static RigidBodyComponent* createWithMesh(Model* model, float bounciness, int id);
